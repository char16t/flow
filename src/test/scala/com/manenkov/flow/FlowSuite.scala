...
class FlowSuite extends AnyFunSuite {
  test("No split") {
    ...
    val perDay = PerDay(8)
    val actual = Flow.flow(original)(perDay.limit, perDay.keyF, perDay.keysRangeF, perDay.next, perDay.updF)
  ...
  test("Per week") {
    ...
    val actual = Flow.flow(original)(perWeek.limit, perWeek.keyF, perWeek.keysRangeF, perWeek.next, perWeek.updF)
    val expected = Seq(
      Event("CA1", isPin = true, LocalDateTime.parse("2022-01-01T00:01")),
      Event("CA2", isPin = true, LocalDateTime.parse("2022-01-01T01:01")),
      Event("CA3", isPin = true, LocalDateTime.parse("2022-01-01T02:01")),
  ...
  test("Per day then per month") {
    ...
    val stage1 = Flow.flow(c)(perMonth.limit, perMonth.keyF, perMonth.keysRangeF, perMonth.next, perMonth.updF)
    val stage2 = Flow.flow(stage1)(perDay.limit, perDay.keyF, perDay.keysRangeF, perDay.next, perDay.updF)
